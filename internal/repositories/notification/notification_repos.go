...
// scopeVisible — filter dasar dipakai List/UnreadCount/MarkAllRead: baris
// yang boleh dilihat userID (personal miliknya ATAU broadcast yang cocok
// role dia / "all"), DIKURANGI yang sudah di-dismiss (dihapus dari daftar)
// oleh userID ini sendiri — lihat catatan di model.NotificationDismissed.
